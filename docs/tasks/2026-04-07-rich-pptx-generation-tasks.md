...
| --- | --- | --- | --- |
| G1 — Hyperlinks | 1 | #1 | Not started |
| G2 — Presentation metadata | 1 | #2 | Not started |
| G3 — Built-in slide numbers | 1 | #3 | Not started |
| G4 — Subscript / superscript | 1 | #4 | Not started |
| G5 — Title shadows | 1 | #5 | Not started |
...
**Complexity:** M
**Category:** frontend
**Dependencies:** None (but do #3 first so slide numbers use the API)
**Files:**
...
**Complexity:** M
**Category:** frontend
**Dependencies:** Depends on #6 (slide masters)
**Files:**
