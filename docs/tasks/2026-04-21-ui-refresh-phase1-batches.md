...
- **Tasks done (100/109)** — Foundation milestones M1.1–M1.10 are landed. Phase 1 itself is NOT closed — M1.11 Functionality + M1.12 Polish + M1.13 Manual QA must land before Phase 1 ships (the new UI is a hollow shell without #101 editor mount + #102 chat mount; per the PRD success criteria "all of today's user flows must verify in the new UI"). M1.1 Foundation (8/8), M1.2 Composer + Orb (21/21), M1.3 Sidebar + Chrome (33/33), M1.4 Settings shell (6/6), M1.5 Removals + external-change rewire (6/6), M1.6 State + plumbing (3/3), M1.7 Accessibility (10/10), M1.8 Performance benchmarks (5/5), M1.9 Docs + release prep (6/6), M1.10 Pre-ship validation (2/2 — checklist artifacts drafted). **Next up: M1.11 Functionality (#101 editor mount, #102 chat mount).**
