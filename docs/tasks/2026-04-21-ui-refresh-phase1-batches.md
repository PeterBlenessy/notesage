...
- **Tasks done (110/127)** — 2026-04-24 second batch: #103/#124 (TitleBar quiet-mode hides dead chat/agent toggle buttons — folded, same work), #117 (AgentSwitchCard + ProjectSwitchCard now render in CommandBarStream), #121 (⌘⇧C expands/unpins bar; ⌘⇧A toggles orb popover — both via dedicated event buses), #123 (⌘⇧L hides/shows Quiet sidebar). Also shipped a small follow-up fix for #119: orb was positioned wrong on main due to a stray `relative` class overriding `fixed` — now `fixed bottom-10 right-6` aligns the orb vertically with the FloatingCommandBar's baseline. All changes green in composition tests, awaiting user live-test. **Currently in flight: none. Next up: #116 (send debug — needs live repro) + M-tier #118/#125/#128/#129/#130 + L-tier #126/#127 + PRD-decision #122 + visual #104/#105/#106/#107/#111 + manual QA #108/#109.**
