...
- **Tasks done (105/127)** — 2026-04-24 evening: #114 (cmd-bar-events bus subscriber + Esc fall-through + TaskMode/SkillMode selector-crash iteration 2), #115 (mount useDoubleTapCmd), #119 (AgentOrb pulse CSS cascade fix), #120 (focus mode collapses cmd bar), #113 (parity audit) all ✅. ⌘K, ⌘⇧P, ⌘1–4, Esc, double-tap ⌘, ⌘. focus mode all live-verified. Orb pulses visibly under activity. **Currently in flight: none. Next up: #116 (send debug — needs live repro) + #117 (AgentSwitchCard + ProjectSwitchCard in stream, S) in parallel, then the M-tier #118/#125/#128/#129/#130 and the L-tier #126/#127 + decisions #121/#122/#123/#124.**
