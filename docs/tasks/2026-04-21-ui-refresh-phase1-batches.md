...
- **Tasks done (100/100)** — Phase 1 complete. M1.1 Foundation (8/8), M1.2 Composer + Orb (21/21), M1.3 Sidebar + Chrome (33/33), M1.4 Settings shell (6/6), M1.5 Removals + external-change rewire (6/6), M1.6 State + plumbing (3/3), M1.7 Accessibility (10/10), M1.8 Performance benchmarks (5/5), M1.9 Docs + release prep (6/6), M1.10 Pre-ship validation (2/2 — checklist artifacts drafted; manual run-through queued as Phase 2 #7 + #8). **Phase 1 closed.** Continuation work in `docs/tasks/2026-04-21-ui-refresh-phase2-tasks.md` (8 tasks: editor mount + chat mount + 4 polish items + 2 manual QA runs).
