...
- **Tasks done (52/100)**: #1-#29 except #22, plus Batch G1 (#30, #39, #48, #49), G2 (#31, #32, #33, #34), G3 (#36, #38, #45, #47), G4 (#37, #43, #44, #46), G5 (#40, #41, #42), G6 (#50, #52, #55, #57). All of M1.1 Foundation (8/8), all of M1.2 Composer + Orb (21/21), plus #22 backend skill parser, the full M1.3 sidebar stack through G5, and G6 chrome foundations (fade-on-type CSS, StatusBar quiet variant, FocusPill component, ViewerToolbarPill primitive). M1.3 remaining: #35 composition settings + G7 chrome dependents (#51, #53, #54, #56). Verify against the ✅ markers in `2026-04-21-ui-refresh-phase1-tasks.md` headings.
- **Tests passing**: 3737/3737 frontend, typecheck clean. (Rust unchanged this batch.)
