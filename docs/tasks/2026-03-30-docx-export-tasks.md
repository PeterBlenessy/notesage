...
**Complexity:** M (30-60 min) **Category:** backend **Dependencies:** None **Files:**
...
**Complexity:** S (&lt; 15 min) **Category:** backend **Dependencies:** None **Files:**
...
**Complexity:** L (2-3 hrs) **Category:** backend **Dependencies:** Depends on #1, #2 **Files:**
...
**Complexity:** L (2-3 hrs) **Category:** backend **Dependencies:** Depends on #3 **Files:**
...
**Complexity:** L (2-3 hrs) **Category:** backend **Dependencies:** Depends on #4 **Files:**
...
**Complexity:** M (1-2 hrs) **Category:** backend **Dependencies:** Depends on #3 **Files:**
...
**Complexity:** S (&lt; 30 min) **Category:** both **Dependencies:** Depends on #3 **Files:**
...
**Complexity:** S (&lt; 15 min) **Category:** frontend **Dependencies:** None **Files:**
...
**Complexity:** M (30-60 min) **Category:** frontend **Dependencies:** Depends on #8 **Files:**
...
**Complexity:** M (30-60 min) **Category:** frontend **Dependencies:** Depends on #7, #9 **Files:**
...
**Complexity:** M (30 min) **Category:** frontend **Dependencies:** Depends on #10 **Files:**
...
**Complexity:** M (30-60 min) **Category:** backend **Dependencies:** Depends on #1 **Files:**
...
**Complexity:** L (2+ hrs) **Category:** backend **Dependencies:** Depends on #5, #6 **Files:**
...
**Complexity:** M (30-60 min) **Category:** frontend **Dependencies:** Depends on #10 **Files:**
