...
| --- | --- | --- | --- |
| V1 — Color transforms | 1 | #1-#2 | Not started |
| V2 — Master/layout inheritance | 1 | #11-#13 | Not started |
| V3 — Body properties | 1 | #3 | Not started |
| V4 — Line/paragraph spacing | 2 | #4 | Not started |
| V5 — Auto-numbered bullets | 2 | #5 | Not started |
| V6 — Table cell borders/margins | 2 | #6 | Not started |
| V7 — Chart titles/legends/axes | 2 | #14 | Not started |
| V8 — Shape shadow | 2 | #15 | Not started |
| V9 — Image crop | 2 | #16 | Not started |
| V10 — Hyperlinks | 2 | #7 | Not started |
| V11 — Preset geometries | 3 | #17-#18 | Not started |
| V12 — Strikethrough/super/sub | 3 | #8 | Not started |
| V13 — Flip transforms | 3 | #9 | Not started |
| V14 — Dash styles | 3 | #10 | Not started |
| V15 — Radar/bubble charts | 3 | #19 | Not started |
| V1-V15 tests | - | #20-#21 | Not started |
...
**Complexity:** L
**Category:** frontend
**Dependencies:** None (but benefits from V1 being done first for correct master colors)
**Files:**
...
**Complexity:** S
**Category:** frontend
**Dependencies:** Depends on #1 (color transforms for shadow color)
**Files:**
