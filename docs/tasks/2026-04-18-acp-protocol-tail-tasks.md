...
**Complexity:** S
**Category:** frontend
**Dependencies:** #1 (conceptually — same file; run sequentially in one worktree)
**Files:**
- `src/hooks/useAgentTaskOperations.ts`
...
**Acceptance criteria:**
- A new auth settings component renders each advertised var as a labeled password-style input, with the agent-provided `link` as a helper (e.g. "Get yours at: <link>")
...
**Complexity:** S
**Category:** backend
**Dependencies:** #7 (the `authenticate` response has to carry enough info to replace the probe)
**Files:**
...
**Complexity:** S
**Category:** frontend (+ one Rust test for #7's end-to-end)
**Dependencies:** #1–#11
**Files:**
