...
***Description***: Replace the old AISettings provider/key section with the new ConnectionsSettings + UseCaseRoutingSettings components in the SettingsDialog. Acceptance criteria: SettingsDialog.tsx AI tab content replaced with ConnectionsSettings + UseCaseRoutingSettings
