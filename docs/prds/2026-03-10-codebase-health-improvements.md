...
**Priority:** High — reliability, deduplication
**Effort:** Medium (~300 lines moved, ~100 new)
...
**Effort:** Medium-Large (largest file, many dependencies)
...
**Priority:** Medium — dependency health
**Effort:** Tiny (drop-in replacement)
