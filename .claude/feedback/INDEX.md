...
- [feedback_verify_platform_ui_in_simulator_first.md](feedback_verify_platform_ui_in_simulator_first.md) — Run mobile UI changes in the simulator and drive the whole round trip — open it, use it, leave it — before cutting a build; stopping at 'it rendered' is how broken builds ship
...
| [feedback_verify_platform_ui_in_simulator_first.md](feedback_verify_platform_ui_in_simulator_first.md) | `yes` | aw-tdd, aw-review | Run mobile UI changes in the simulator and drive the whole round trip — open it, use it, leave it — before cutting a build; stopping at 'it rendered' is how broken builds ship |
