...
pub fn run() {
    ...
    let builder = builder.invoke_handler(tauri::generate_handler![
        ...
        ios_set_chrome,
        ios_set_library_browsing,
        ios_set_library_speech,
        ios_set_library_view,
        ios_set_library_filter,
        ios_reload_library_screens,
            ios_present_report,
            ios_nav_shell_present,
            ios_nav_shell_prepare,
            ios_nav_shell_push,
            ios_nav_shell_pop,
            ios_nav_shell_pop_to_root,
            ios_nav_shell_set_title,
            ios_nav_shell_rendered,
            ios_nav_shell_set_action,
            ios_nav_shell_dismiss,
            ios_dismiss_report,
            ios_find_in_report,
            ios_post_to_report,
            ios_share_file,
