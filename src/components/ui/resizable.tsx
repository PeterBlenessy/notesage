...
function ResizableHandle({
  ...
  return (
    <ResizablePrimitive.Separator
      ...
      className={cn(
        "relative flex w-px items-center justify-center bg-border hover:bg-muted-foreground after:absolute after:inset-y-0 after:left-1/2 after:w-4 after:-translate-x-1/2 outline-none focus-visible:[outline:1px_solid_var(--color-accent-primary)] focus-visible:[outline-offset:2px] aria-[orientation=horizontal]:h-px aria-[orientation=horizontal]:w-full aria-[orientation=horizontal]:after:left-0 aria-[orientation=horizontal]:after:h-4 aria-[orientation=horizontal]:after:w-full aria-[orientation=horizontal]:after:translate-x-0 aria-[orientation=horizontal]:after:-translate-y-1/2 [&[aria-orientation=horizontal]>div]:rotate-90 transition-colors cursor-col-resize aria-[orientation=horizontal]:cursor-row-resize",
        className
      )}
      {...props}
    >
