  ...
  return (
    <>
      ...
      <Button
        ...
        className={zoom.fitMode === "width" ? "bg-accent text-foreground" : "text-muted-foreground"}
        title="Fit to width"
      >
      ...
      <Button
        ...
        className={zoom.fitMode === "page" ? "bg-accent text-foreground" : "text-muted-foreground"}
        title="Fit to page"
      >
