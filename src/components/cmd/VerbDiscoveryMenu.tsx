...
/**
 * Bare `:` (or `:partial-name`) discovery list. Renders every registered verb
 * whose name starts with the typed partial; an empty `typedName` surfaces all
 * verbs. Click / Enter on a row autocompletes to `:fullName ` and jumps the
 * cursor into the filter slot.
 */
