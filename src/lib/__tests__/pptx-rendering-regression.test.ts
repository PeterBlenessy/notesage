...
const FIXTURE_FILES = [
  "45545_Comment.pptx",
  "GS_Tables_Merged.pptx",
  "ms-workshop-template.pptx",
  "RootTemplateWithCharts.pptx",
  "ShapeTypesCollection.pptx",
  "SlideMasterBackgrounds.pptx",
  "SlideMasters.pptx",
  "slideshow-sample.pptx",
  "SlideWithCharts.pptx",
  "SlideWithDiagrams.pptx",
  "SlideWithImages.pptx",
  "SlideWithLink.pptx",
  "SlideWithNotes.pptx",
  "SlideWithShapes.pptx",
  "SlideWithTables.pptx",
  "SVGImages.pptx",
  "terraform-presentation.pptx",
  "TextReplaceBullets.pptx",
  "backgrounds.pptx",
  "bar-chart.pptx",
  "line-chart.pptx",
