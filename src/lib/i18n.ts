...
const en = {
  ...
  "toast.saveFailed": "Failed to save file: {error}",
...
const sv: Dict = {
  ...
  "chat.plan": "Plan",
  "toast.fileSaved": "Filen sparades",
  "toast.saveFailed": "Kunde inte spara filen: {error}",
  "toast.copied": "Kopierat till urklipp",
  "toast.deleted": "Tog bort ”{name}”",
  "toast.deleteFailed": "Kunde inte ta bort: {error}",
  "toast.renamed": "Namnändrad till ”{name}”",
  "toast.renameFailed": "Kunde inte byta namn: {error}",
